...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('paypal_ipn', 'case_id', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'PayPalIPN.reason_code'
        db.alter_column('paypal_ipn', 'reason_code', self.gf('django.db.models.fields.CharField')(max_length=32))

    def backwards(self, orm):

        # Changing field 'PayPalIPN.case_id'
        db.alter_column('paypal_ipn', 'case_id', self.gf('django.db.models.fields.CharField')(max_length=14))

        # Changing field 'PayPalIPN.reason_code'
        db.alter_column('paypal_ipn', 'reason_code', self.gf('django.db.models.fields.CharField')(max_length=15))
    ...
    models = {
        u'ipn.paypalipn': {
            ...
            'reason_code': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'}),
